...
ggplot(Forward_yellow) + geom_col(aes(y=Yellow_cards, x=Name), fill = "#F6BE00") + 
...
The table \@ref(tab:Top) displays the top 5 forward position players in the LaLiga Tournament according to the 2019-2022 data on the basis of their goals, assists, successful duels and tackles per game and after removing the players with high number of yellow cards. **Messi from Barcelona** is at the top of the list followed by M. Gómez, Jorge Molina, Williams and Enric Gallego.\
